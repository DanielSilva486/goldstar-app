...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans">
      <button onClick={() => setMostrarNovoAtendimento(true)} className="fixed bottom-8 right-8 z-50 w-14 h-14 bg-teal-500 hover:bg-teal-600 text-white rounded-full shadow-[0_10px_25px_rgba(20,184,166,0.4)] flex items-center justify-center transition-all active:scale-90">
